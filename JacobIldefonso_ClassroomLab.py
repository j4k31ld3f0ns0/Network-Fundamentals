...
print(smallClassroom2[1])
print(f"Small Classroom 3 network address: {smallClassroom2[1].network_address}")
print(f"Small Classroom 3 broadcast address: {smallClassroom2[1].broadcast_address}")
print(f"Small Classroom 3 number of hosts: {len(list(smallClassroom2[1].hosts()))}")
print(f"Small Classroom 3 valid host range: {smallClassroom2[1].network_address+1} to {smallClassroom2[1].broadcast_address-1}")

print("---------------------------------------------------------------------------------------")
time.sleep(1)

print('Small Classroom 4')
print(smallClassroom1[1])
print(f"Small Classroom 4 network address: {smallClassroom1[1].network_address}")
print(f"Small Classroom 4 broadcast address: {smallClassroom1[1].broadcast_address}")
print(f"Small Classroom 4 number of hosts: {len(list(smallClassroom1[1].hosts()))}")
print(f"Small Classroom 4 valid host range: {smallClassroom1[1].network_address+1} to {smallClassroom1[1].broadcast_address-1}")

print("---------------------------------------------------------------------------------------")
time.sleep(1)

print('Normal Classroom 1')
print(classroom[0])
print(f"Small Classroom 4 network address: {classroom[0].network_address}")
print(f"Small Classroom 4 broadcast address: {classroom[0].broadcast_address}")
print(f"Small Classroom 4 number of hosts: {len(list(classroom[0].hosts()))}")
print(f"Small Classroom 4 valid host range: {classroom[0].network_address+1} to {classroom[0].broadcast_address-1}")

print("---------------------------------------------------------------------------------------")
time.sleep(1)

print('Normal Clasroom 2')
print(classroom[1])
print(f"Small Classroom 4 network address: {classroom[1].network_address}")
print(f"Small Classroom 4 broadcast address: {classroom[1].broadcast_address}")
print(f"Small Classroom 4 number of hosts: {len(list(classroom[1].hosts()))}")
print(f"Small Classroom 4 valid host range: {classroom[1].network_address+1} to {classroom[1].broadcast_address-1}")
